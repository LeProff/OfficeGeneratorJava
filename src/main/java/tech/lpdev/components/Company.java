...
public class Company {
    ...
    private int age, floors, totalEmployees, executives, hr, finance, purchasing, salesAndMarketing, security, communications, legal, it, specialtyOne, specialtyTwo;
...
//        BufferedReader file = new BufferedReader(new FileReader("src/main/java/tech/lpdev/companynames.txt"));
        List<String> lines = file.lines().toList();
        this.name = lines.get(MathUtil.random(0, lines.size() - 1));
        file.close();

//        file = new BufferedReader(new FileReader("src/main/java/tech/lpdev/companytypes.txt"));
    ...
    public String toString() {
        ...
        sb.append(ConsoleColour.DARK_BLUE + "Floors: " + ConsoleColour.GREEN + this.floors + "\n");
